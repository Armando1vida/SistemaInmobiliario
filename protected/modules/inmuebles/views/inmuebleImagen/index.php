...
$this->menu=array(
    //array('label' => Yii::t('AweCrud.app', 'List') . ' ' . InmuebleImagen::label(2), 'icon' => 'list', 'itemOptions'=>array('class'=>'active')),
...
<fieldset>
    <legend>
        <?php echo Yii::t('AweCrud.app', 'List') ?> <?php echo InmuebleImagen::label(2) ?>    </legend>
